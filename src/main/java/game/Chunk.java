...
public class Chunk {
    ...
    private static final int BLEND_STEPS = 10;
    private static final float BLEND_EDGE_START = 0.25f;
    private static final float BLEND_EDGE_END = 0.75f;
    ...
    private int quantizeAlpha(float alpha) {
        int bucket = Math.round(Math.max(0f, Math.min(1f, alpha)) * BLEND_STEPS);
