...
/*EVEN BIOMES NOT FINNISHED
    ...
    public void drawTerrainAndFeatures(float wx, float wz) {
        ...
        for (Chunk c : chunks.values()) {
            ...
            c.drawTerrainAndFeatures(dist, featureDetailDistance, grassDetailDistance, featureRenderDist);
        }
    ...
    public void drawDepth(float wx, float wz) {
        ...
        for (Chunk c : chunks.values()) {
            ...
            c.renderDepth(dist, featureDetailDistance, grassDetailDistance, featureRenderDist);
        }
    }
