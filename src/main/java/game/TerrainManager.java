...
public class TerrainManager {
    ...
    private int featureDetailDistance;
    ...
    public TerrainManager(long seed, float scale, int renderDist, int featureRenderDist,SkyRenderer skyRenderer) {
        ...
        this.featureDetailDistance = Math.max(1, featureRenderDist - 1);
...
/*EVEN BIOMES NOT FINNISHED
    ...
    public void drawTerrainAndFeatures(float wx, float wz) {
        ...
        int pcx = (int) Math.floor(wx / (Chunk.SIZE * scale));
        int pcz = (int) Math.floor(wz / (Chunk.SIZE * scale));
        int featureDetailDistance = Math.max(0, this.featureDetailDistance);
        int grassDetailDistance = Math.max(0, this.grassDetailDistance);
    ...
    public void setFeatureRenderDistance(int r) {
        ...
        shadowRenderDist = Math.max(shadowRenderDist, renderDist + 12);
        featureDetailDistance = Math.min(featureDetailDistance, featureRenderDist);
    ...
    public void setFeatureDetailDistance(int r) {
        featureDetailDistance = Math.max(0, Math.min(r, featureRenderDist));
    }

    public int getFeatureDetailDistance() {
        return featureDetailDistance;
    }
