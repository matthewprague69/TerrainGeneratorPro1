...
public enum Biome {
        ...
        MOUNTAINS(0.75f, 0.008f, 200f, 90f, 1.0f, "grass.png", "dirt.png", "rock.png", 0.215f, 0.25f),
        HIGH_MOUNTAINS(0.90f, 0.002f, 700f, 300f, 2f, "grass.png", "dirt.png", "rock.png", 0.02f, 0.05f),
        ...
        public static float featureSpawnMultiplier = 0.1f;
        ...
        static {
                ...
                SWAMP.features = Map.of(
                        new TreeSpawner(TreeType.SWAMP_TREE), 0.02f * m,
                        new GrassSpawner(SWAMP.grassTex), 0.2f * m,
